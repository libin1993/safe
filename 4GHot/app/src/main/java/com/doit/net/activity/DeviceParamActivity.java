...
//    private RadioButton rbPowerLow;
    ...
    private void intView() {
        ...
        btnGSM = findViewById(R.id.btn_gsm);
        btnGSM.setOnClickListener(gsmClick);
...
//                if ("1".equals(lteChannelCfg.getBand()) || "39".equals(lteChannelCfg.getBand()) || "40".equals(lteChannelCfg.getBand())){
//                    return;
//                }
    ...
    View.OnClickListener gsmClick = new View.OnClickListener() {
        @Override
        public void onClick(View v) {

            View contentView = LayoutInflater.from(DeviceParamActivity.this).inflate(R.layout.popup_gsm_fcn, null);
            PopupWindow mPopupWindow = new PopupWindow(contentView, ViewGroup.LayoutParams.WRAP_CONTENT,
                    ViewGroup.LayoutParams.WRAP_CONTENT);

            EditText etFcn1 = contentView.findViewById(R.id.et_gsm_fcn1);
            EditText etFcn2= contentView.findViewById(R.id.et_gsm_fcn2);
            Button btnCancel = contentView.findViewById(R.id.btn_cancel_gsm);
            Button btnSave = contentView.findViewById(R.id.btn_save_gsm);

            etFcn1.setText(PrefManage.getString(PrefManage.GSM_CTJ_FCN,"60"));
            etFcn2.setText(PrefManage.getString(PrefManage.GSM_CTU_FCN,"120"));
            ...
            btnSave.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (TextUtils.isEmpty(fcn1) || TextUtils.isEmpty(fcn2)){
                        ToastUtils.showMessage("请输入频点");
                        return;
                    }

                    PrefManage.setString(PrefManage.GSM_CTJ_FCN,fcn1);
                    PrefManage.setString(PrefManage.GSM_CTU_FCN,fcn2);
