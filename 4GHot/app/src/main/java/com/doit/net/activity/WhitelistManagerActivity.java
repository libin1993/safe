...
//            if (!file.exists()) {
//                ToastUtils.showMessageLong("未找到名单，请确认已将名单放在\"手机存储/"+FileUtils.ROOT_DIRECTORY+"\"目录下");
//                return;
//            }
//
...
//
//            if (fileList.size() == 0) {
//                ToastUtils.showMessageLong("未找到名单，名单必须是以\".xls\"或\".xlsx\"或\".txt\"为后缀的文件");
//                return;
//            }
//
//
...
//                }
                ...
                try {
                    ...
                    LogUtils.log("导入名单错误"+e.toString());
    ...
    protected String getCellAsString(Row row, int c, FormulaEvaluator formulaEvaluator) {
        ...
        try {
            ...
            e.printStackTrace();
            LogUtils.log("名单解析异常："+e.toString());
        }
        return value;
    }
